...
!
  ...
  TYPE, PUBLIC :: OptInput
     ...
     !----------------------------------------
     LOGICAL                     :: DO_ND99
     CHARACTER(LEN=255)          :: ND99_FILE
     INTEGER,            POINTER :: ND99_TRACERS(:)
     INTEGER                     :: ND99_FREQ
     INTEGER                     :: ND99_IMIN
     INTEGER                     :: ND99_IMAX
     INTEGER                     :: ND99_JMIN
     ...
     INTEGER                     :: GPSAT_NREG
     INTEGER                     :: GPSAT_NCUS
     CHARACTER                   :: GPSAT_FNAMES
     CHARACTER                   :: GPSAT_FNAMEO
...
!
    ...
    Input_Opt%DO_DIAG_WRITE          = .TRUE.
     ...
     Input_Opt%DO_GPSAT               = .FALSE.
     Input_Opt%GPSAT_NREG             = 0
     Input_Opt%GPSAT_NCUS             = 0
     Input_Opt%GPSAT_FNAMES           = ''
     Input_Opt%GPSAT_FNAMEO           = ''
    ...
    ! ND99 MENU fields
    !----------------------------------------
    ALLOCATE( Input_Opt%ND99_TRACERS( MAX_TRCS ), STAT=RC )

    Input_Opt%DO_ND99                = .FALSE.
    Input_Opt%ND99_FILE              = ''
    Input_Opt%ND99_TRACERS           = 0
    Input_Opt%ND99_FREQ              = 0
    Input_Opt%ND99_IMIN              = 0
    Input_Opt%ND99_IMAX              = 0
    Input_Opt%ND99_JMIN              = 0
    Input_Opt%ND99_JMAX              = 0
    Input_Opt%ND99_LMIN              = 0
    Input_Opt%ND99_LMAX              = 0
...
!BOC
    ...
    IF ( ASSOCIATED( Input_Opt%ND99_TRACERS ) ) THEN
       DEALLOCATE( Input_Opt%ND99_TRACERS )
    ENDIF
