...
!     REAL*8,            POINTER :: Spec_GPSAT (:,:,:,:)  ! Species [molec/cm3]
     ! Spec_GPSAT is used to help simplify the emission sorting and tracking
     ! within the GPSAT module. Aside from that it is not used.
